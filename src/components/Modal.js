...
function Modal()  {
    ...
    //const handleClose = () => setModal(false);
        ...
        <div className='z-50 absolute top-0 bottom-0 left-0 right-0'>
            <div className="fixed py-12 h-full bg-gradient-to-br from-red-600  to-orange-400 opacity-60 transition duration-150 ease-in-out z-10 top-0 right-0 bottom-0 left-0" id="modal"></div>
